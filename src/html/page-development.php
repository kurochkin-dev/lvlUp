        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 col-xl-4 col-md-4 col-sm-12">
                <ul class="sites__main-list">
                    ...
                    <li class="main-list__item">
                        <a class="main-list__link" href="#">Сайт-визитка</a>
                    </li>
                    <li class="main-list__item">
                        <a class="main-list__link" href="#">Многостраничный сайт</a>
                    </li>
                    <li class="main-list__item">
                        <a class="main-list__link" href="#">Сайт-каталог</a>
                    </li>
                    <li class="main-list__item">
                        <a class="main-list__link" href="#">Интернет-магазин</a>
                    </li>
                </ul>
            </div>
            <div class="col-12 col-lg-6 col-xl-6 col-md-6 col-sm-12">
                <div class="sites__block">
                    ...
                    <p class="sites__desc">Основная цель такой страницы – привлекать внимание клиента, мотивировать его
                        сделать заказ.</p>
                    <button class="sites__button btn">Заказать лендинг</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-xl-5 col-lg-5 col-md-12 col-sm-12">
                ...
                <div class="stages__three-wrap">
                    ...
                    <ul class="stages__block-list">
                        ...
                        <li class="block-list__item"><span class="block-list__marker"></span>визуальное решение креативной
                            идеи
                        </li>
                        <li class="block-list__item"><span class="block-list__marker"></span>дизайн макетов типовых страниц
                        </li>
                        <li class="block-list__item"><span class="block-list__marker"></span>разработка анимации и сценариев
                            верстки
                        </li>
                    </ul>
                </div>
                <div class="stages__five-wrap">
                    ...
                    <ul class="stages__block-list">
                        <li class="block-list__item"><span class="block-list__marker"></span>
                            разработка дизайн-концепции и
                            набросков
                        </li>
                        <li class="block-list__item"><span class="block-list__marker"></span>
                            визуальное решение креативной
                            идеи
                        </li>
                        <li class="block-list__item"><span class="block-list__marker"></span>
                            дизайн макетов типовых страниц
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-12 col-xl-5 col-lg-5 col-md-12 col-sm-12">
                <div class="stages__two-wrap">
                    ...
                    <ul class="stages__block-list">
                        ...
                        <li class="block-list__item"><span class="block-list__marker"></span>разработка контент-стратегии и
                            структуры
                        </li>
                        <li class="block-list__item"><span class="block-list__marker"></span>разработка технического задания
                        </li>
